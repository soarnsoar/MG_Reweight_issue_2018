...
'file:/cms/ldap_home/jhchoi/generator_group/reweight_issue/GEN_sample_production/all/JOB_dyee012j_5f_LO_26x_PDFWGT/OUTPUT_IJOB.root'
#'file:dyee012j_5f_LO_26x_false_pdfwgt.root'
#'file:SMP-RunIISummer15GS-00080.root' 
     )
)
       
process.Analyzer = cms.EDAnalyzer('weight_assign_26xLO',
