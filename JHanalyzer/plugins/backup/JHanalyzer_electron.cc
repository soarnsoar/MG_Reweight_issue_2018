// -*- C++ -*-
//
// Package:    Analyzer/JHanalyzer_electron
// Class:      JHanalyzer_electron
// 
/**\class JHanalyzer_electron JHanalyzer_electron.cc Analyzer/JHanalyzer_electron/plugins/JHanalyzer_electron.cc
...
class JHanalyzer_electron : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit JHanalyzer_electron(const edm::ParameterSet&);
      ~JHanalyzer_electron();
...
//
JHanalyzer_electron::JHanalyzer_electron(const edm::ParameterSet& iConfig)
...
JHanalyzer_electron::~JHanalyzer_electron()
{
...
void
JHanalyzer_electron::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ////////////initialize/////////////
  weight=1;
...
void 
JHanalyzer_electron::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
JHanalyzer_electron::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(JHanalyzer_electron);
